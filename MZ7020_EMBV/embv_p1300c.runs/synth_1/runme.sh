...
HD_PWD='F:/Avnet/hdl/Projects/embv_p1300c/MZ7020_EMBV/embv_p1300c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embv_p1300c_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source embv_p1300c_wrapper.tcl
