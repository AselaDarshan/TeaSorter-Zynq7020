...
HD_PWD='F:/Avnet/hdl/Projects/embv_p1300c/MZ7020_EMBV/embv_p1300c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log embv_p1300c_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source embv_p1300c_wrapper.tcl -notrace
